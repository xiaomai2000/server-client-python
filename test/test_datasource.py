...
class DatasourceTests(unittest.TestCase):
    ...
    def test_get(self):
        ...
        ds1 = all_datasources[0]
        ds2 = all_datasources[1]

        self.assertEqual('0d826bf5-7740-4a1f-a9d4-bc9f593907c2', ds1.id)
        self.assertEqual('Sheet1 (Tab)', ds1.name)
        self.assertEqual('Sheet1Tab', ds1.content_url)
        self.assertEqual('http://test/#/datasources/14', ds1.webpage_url)
        self.assertEqual('ds1', ds1.description)
        self.assertEqual('google-sheets', ds1.datasource_type)
        self.assertEqual('2019-03-12T20:46:05Z', format_datetime(ds1.created_at))
        self.assertEqual('2019-03-12T21:29:09Z', format_datetime(ds1.updated_at))
        self.assertEqual(False, ds1.certified)
        self.assertEqual('server', ds1.server_name)
        self.assertEqual('Tab', ds1.database_name)
        self.assertEqual(True, ds1.has_extracts)
        self.assertEqual(False, ds1.has_alert)
        self.assertEqual(1, ds1.size)
        self.assertEqual(True, ds1.published)
        self.assertEqual(0, ds1.connected_workbooks_count)
        self.assertEqual(0, ds1.favorites_total)
        self.assertEqual(False, ds1.encrypt_extracts)
        self.assertEqual(False, ds1.use_remote_query_agent)
        self.assertEqual('bdd975c6-4042-11e9-a712-975dc31937aa', ds1.project_id)
        self.assertEqual('Default', ds1.project_name)
        self.assertEqual('344356bd-a847-4d6c-8370-8b2821498cdb', ds1.owner_id)
        self.assertEqual('testadmin', ds1.owner_name)
        self.assertEqual(set(), ds1.tags)

        self.assertEqual('f8832e2d-a002-491e-91bd-3302f32ab279', ds2.id)
        self.assertEqual('dataengine.42019', ds2.name)
        self.assertEqual('dataengine_42019', ds2.content_url)
        self.assertEqual('http://test/#/datasources/15', ds2.webpage_url)
        self.assertEqual('datasource2', ds2.description)
        self.assertEqual('hyper', ds2.datasource_type)
        self.assertEqual('2019-03-12T22:06:26Z', format_datetime(ds2.created_at))
        self.assertEqual('2019-03-13T16:39:10Z', format_datetime(ds2.updated_at))
        self.assertEqual(True, ds2.certified)
        self.assertEqual(None, ds2.server_name)
        self.assertEqual('databasename.tmp', ds2.database_name)
        self.assertEqual(False, ds2.has_extracts)
        self.assertEqual(False, ds2.has_alert)
        self.assertEqual(3, ds2.size)
        self.assertEqual(True, ds2.published)
        self.assertEqual(1, ds2.connected_workbooks_count)
        self.assertEqual(9, ds2.favorites_total)
        self.assertEqual(False, ds2.encrypt_extracts)
        self.assertEqual(False, ds2.use_remote_query_agent)
        self.assertEqual('bdd975c6-4042-11e9-a712-975dc31937aa', ds2.project_id)
        self.assertEqual('Default', ds2.project_name)
        self.assertEqual('344356bd-a847-4d6c-8370-8b2821498cdb', ds2.owner_id)
        self.assertEqual('testadmin', ds2.owner_name)
        self.assertEqual(set(['a', 'b', 'c']), ds2.tags)
    ...
    def test_get_by_id(self):
        ...
        self.assertEqual('0d826bf5-7740-4a1f-a9d4-bc9f593907c2', single_datasource.id)
        self.assertEqual('Sheet1 (Tab)', single_datasource.name)
        self.assertEqual('Sheet1Tab', single_datasource.content_url)
        self.assertEqual('http://test/#/datasources/14', single_datasource.webpage_url)
        self.assertEqual('ds1', single_datasource.description)
        self.assertEqual('google-sheets', single_datasource.datasource_type)
        self.assertEqual('2019-03-12T20:46:05Z', format_datetime(single_datasource.created_at))
        self.assertEqual('2019-03-13T17:13:21Z', format_datetime(single_datasource.updated_at))
        self.assertEqual(False, single_datasource.certified)
        self.assertEqual("certified", single_datasource.certification_note)
        self.assertEqual(False, single_datasource.encrypt_extracts)
        self.assertEqual(False, single_datasource.use_remote_query_agent)
        self.assertEqual('bdd975c6-4042-11e9-a712-975dc31937aa', single_datasource.project_id)
        self.assertEqual('Default', single_datasource.project_name)
        self.assertEqual('344356bd-a847-4d6c-8370-8b2821498cdb', single_datasource.owner_id)
        self.assertEqual(set(['1', '2', '3']), single_datasource.tags)
